...
class videoController extends Controller
{
    ...
    public function show($id)
    {
        ...
        // Temukan user yang terkait dengan video
        $user = User::find($video->user_id);

        // Ambil video lain secara acak, kecuali video yang sedang diputar
        $otherVideos = Video::where('id', '!=', $id)->inRandomOrder()->take(5)->get();
...
public function showRecommendations()
{
    ...
    $videos = Video::with('user')->inRandomOrder()->take(5)->get(); // Ambil 5 video acak

    // Kirim variabel $videos ke view
    return view('videoShow', compact('videos'));
}
