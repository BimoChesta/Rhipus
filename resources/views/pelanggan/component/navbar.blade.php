    <nav class="navbar navbar-dark navbar-expand-lg" style="background-color:rgb(29, 123, 142)">
        <div class="container">
            <a class="navbar-brand" href="/admin">Toko Rhipus</a>
            ...
            <div class="collapse navbar-collapse justify-content-end gap-4" id="navbarSupportedContent">
                ...
                <li class="nav-item">
                <a class="nav-link {{ Request::path() == 'beranda' ? 'active' : '' }}" aria-current="page" href="/beranda">Beranda</a></li>
                    </li>
                    <li class="nav-item">
                        ...
                        <div class="select" tabindex="0" role="button">
                            ...
                            <div class="links-login text-white" id="links-login">
                                <a href="logout_pelanggan" style="text-decoration: none" role="button"
                                    tabindex="0">Keluar</a>
                                    <a href="/profil" style="text-decoration: none" role="button"
                                    tabindex="0">Profile</a>
                                    <a href="/pengaturan" style="text-decoration: none" role="button"
