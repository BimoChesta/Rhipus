                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-7">
                            <select type="text" class="form-control" id="type" name="type">
                                ...
                                <option value="Hiasan" {{ $data->type === 'Hiasan' ? 'selected' : '' }}>Hiasan</option>
                                <option value="Aksesoris" {{ $data->type === 'Aksesoris' ? 'selected' : '' }}>Aksesoris</option>
                                <option value="Rumah Tangga" {{ $data->type === 'Rumah Tangga' ? 'selected' : '' }}>Perabotan</option>
                            </select>
                        </div>
                    </div>
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-7">
                            <select type="text" class="form-control" id="kategori" name="kategori">
                                ...
                                <option value="Hiasan" {{ $data->kategory === 'Hiasan' ? 'selected' : '' }}>Hiasan</option>
                                <option value="Aksesoris" {{ $data->kategory === 'Aksesoris' ? 'selected' : '' }}>Aksesoris</option>
                                <option value="Rumah Tangga" {{ $data->kategory === 'Anak-anak' ? 'selected' : '' }}>Perabotan</option>
                            </select>
                        </div>
                    </div>
                    <div class="mb-3 row">
